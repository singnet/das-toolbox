...
const form = useRef((() => {
    const fullEndpoint = getDefault("agents.command_router.endpoint") || "0.0.0.0:40000"
    const fullRange = getDefault("agents.command_router.ports_range") || "42000:42999"
...
const handleSave = () => {
    updateField("agents.command_router", {
