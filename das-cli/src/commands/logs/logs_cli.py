...
class LogsContextAgent(Command):
    ...
    short_help = "Display logs for the Context Agent service"

    help = """
'das-cli logs context-agent' displays the logs of the Context Agent service.
This command retrieves the logs generated by the Context Agent, which may include information about evolution processes, agent events, and errors.

.SH EXAMPLES

Display logs of the Context Agent service.

$ das-cli logs context-agent
"""
    ...
    @ensure_container_running(
        ["_context_agent_container_manager"],
        exception_text="Context Agent is not running. Please start it with 'das-cli context-agent start' before viewing logs.",
        verbose=False,
    )
    def run(self):
        self._settings.raise_on_missing_file()
        ...
        self._context_agent_container_manager.logs()
...
COMMANDS
    ...
    das-cli logs context-agent              Logs from the Context Agent service
...
EXAMPLES
    ...
    Display logs from the Context Agent service:
...
"""
    ...
    def __init__(
        ...
        logs_context_agent: LogsContextAgent,
    ) -> None:
        super().__init__()
        self.add_commands(
            [
