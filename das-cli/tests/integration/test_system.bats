...
@test "Trying to show the system status with unset configuration file" {
    ...
    assert_output --partial "[31m[FileNotFoundError] No existing configuration path was found. You can run the command \`config set\` to create a configuration file or point to an existing file.[39m"
}
